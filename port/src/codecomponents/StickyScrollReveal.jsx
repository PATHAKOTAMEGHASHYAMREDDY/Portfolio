...
import neighbourCommunity from "../assets/images/NeighbourCommunity.png"

const content = [
  {
    title: "Neighborhood Community Help Portal",
    description:
      "Community Connect is a TypeScript-based full-stack platform that connects residents with local helpers for community assistance. It features real-time chat via Socket.IO, secure JWT authentication with role-based access, OTP-based password recovery, and comprehensive admin analytics. Built with Node.js, Angular 19, and MySQL, it promotes safe, efficient, and community-driven support services.",
    content: (
      <div className="h-full w-full flex flex-col overflow-hidden rounded-xl bg-white shadow-lg">
        <div className="flex-1 min-h-0 p-2">
          <img
            src={neighbourCommunity}
            alt="Neighborhood Community Help Portal"
        ...
        <div className="p-4 bg-white flex-shrink-0">
          <div className="flex gap-3 justify-center">
            <a
              href="https://github.com/PATHAKOTAMEGHASHYAMREDDY/Neighborhood-Community-Help-Portal"
              target="_blank"
            ...
            <a
              href="https://neighborhood-community-help-portal.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
